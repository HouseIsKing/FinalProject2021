...
[RequireComponent(typeof(HealthManager), typeof(Actor), typeof(NavMeshAgent))]
public class EnemyController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<HealthManager, EnemyController>(m_Health, this, gameObject);
