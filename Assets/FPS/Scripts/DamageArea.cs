...
public class DamageArea : MonoBehaviour
{
    ...
    {
        Dictionary<HealthManager, Damageable> uniqueDamagedHealths = new Dictionary<HealthManager, Damageable>();
        ...
        foreach (var coll in affectedColliders)
        {
            ...
            if (damageable)
            {
                HealthManager health = damageable.GetComponentInParent<HealthManager>();
