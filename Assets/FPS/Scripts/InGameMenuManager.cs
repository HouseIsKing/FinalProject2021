...
public class InGameMenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_PlayerHealth = m_PlayerInputsHandler.GetComponent<HealthManager>();
        DebugUtility.HandleErrorIfNullGetComponent<HealthManager, InGameMenuManager>(m_PlayerHealth, this, gameObject);
