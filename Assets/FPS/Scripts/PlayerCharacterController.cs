...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<HealthManager, PlayerCharacterController>(m_Health, this, gameObject);
    ...
    {
        return obj is PlayerCharacterController controller &&
               base.Equals(obj) &&
               CharacterVelocity.Equals(controller.CharacterVelocity);
    }

    public override int GetHashCode()
    {
        int hashCode = 219271897;
        hashCode = hashCode * -1521134295 + base.GetHashCode();
        hashCode = hashCode * -1521134295 + CharacterVelocity.GetHashCode();
        return hashCode;
    }
}
